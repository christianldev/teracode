        ...
        <div className="space-y-[70px]">
          <div className="max-w-[900px] space-y-3">
            <RevealAnimation delay={0.2}>
              <h1 className="text-heading-3 md:text-heading-2 font-normal">How leading teams grow with TeraCode</h1>
            </RevealAnimation>
            <RevealAnimation delay={0.3}>
              <p>
                From fast-moving startups to established enterprises, businesses around the world use TeraCode to

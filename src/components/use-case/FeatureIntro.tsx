      ...
      <div className="main-container">
        <div className="mx-auto mb-14 max-w-[660px] space-y-3 text-center md:mb-[70px]">
          ...
          <RevealAnimation delay={0.2}>
            <p>
              TeraCode is designed to serve a wide range of teams and industries. Whether you’re managing data, scaling
              operations, optimizing finances, or streamlining customer experiences—TeraCode is the platform that grows
              with you.
            </p>
          </RevealAnimation>
        </div>

            ...
            <div className="space-y-2">
              ...
              <RevealAnimation delay={0.2}>
                <p>
                  ...
                  <br />
                  From roadmap planning to feature tracking, product teams use TeraCode to keep everyone aligned and
            ...
            <div className="space-y-2">
              ...
              <RevealAnimation delay={0.2}>
                <p>
                  ...
                  <br />
                  TeraCode helps marketers connect strategy to results, with built-in analytics and collaborative tools
            ...
            <div className="space-y-2">
              ...
              <RevealAnimation delay={0.2}>
                <p>
                  ...
                  <br />
                  TeraCode gives leadership teams the visibility they need across every department—all in one unified
                  view.
                </p>
              </RevealAnimation>
            </div>
            ...
            <div className="space-y-2">
              ...
              <RevealAnimation delay={0.2}>
                <p>
                  ...
                  <br />
                  Even small teams can get big results. Use TeraCode to manage your pipeline, track progress, and
              ...
              <RevealAnimation delay={0.5}>
                <li className="flex items-center gap-2">
                  ...
                  <p>
                    ...
                    <span className="text-secondary">support@TeraCode.com</span>
                  </p>
                </li>
              </RevealAnimation>
            </ul>

...
const brandCards: BrandCard[] = [
  {
    id: '1',
    image: nsImg376,
    alt: 'TeraCode.ai logo',
    title: 'TeraCode.ai: redefining the future of art and technology',
    description:
      "ArtReview spoke with the founders of TeraCode.ai about how their platform bridges creativity and AI. The discussion explored artists' rights, ethical AI model training, and the collaboration between technology and creative innovation.",
    delay: 0.4,
  },
  {
    id: '2',
    image: nsImg377,
    alt: 'Arts Club logo',
    title: 'Reimagining the AI rulebook for creators with TeraCode.ai',
    description:
      'After a successful showcase at Shoreditch Arts Club last year, TeraCode.ai returns for Digital Art Week 2025. This time, the team focuses on empowering creators with transparent, ethical tools that give full control over their AI-driven creative process.',
    delay: 0.5,
  },
  {
    id: '3',
    ...
    description:
      'Recognized by TechRound as one of the most promising creative AI platforms, TeraCode.ai enables illustrators and designers to use AI to scale their work, save time, and grow new revenue streams all while keeping complete ownership of their art.',
    delay: 0.6,
  },
];
        ...
        <div className="mx-auto w-full max-w-[850px] space-y-17.5 pb-16 lg:pb-20 xl:pb-28">
          <RevealAnimation delay={0.1}>
            <div className="space-y-6">
              <h2 className="text-heading-4 font-normal">Download TeraCode.ai logo</h2>
              <div className="flex flex-col items-start gap-y-5 md:gap-y-8 lg:flex-row lg:gap-x-8">
                <div className="w-full space-y-4">
                  <figure className="bg-secondary flex w-full items-center justify-center overflow-hidden rounded-[20px] px-[92px] py-[127px]">
                    <Image src={mainLogoDark} alt="TeraCode.ai logo" />
                  </figure>
                  <Link
                    download=""
                ...
                <div className="w-full space-y-4">
                  <figure className="flex w-full items-center justify-center overflow-hidden rounded-[20px] bg-white px-[92px] py-[127px]">
                    <Image src={mainLogoLight} alt="TeraCode.ai logo" />
                  </figure>
                  <Link
                    download=""
          ...
          <RevealAnimation delay={0.2}>
            <div className="space-y-6">
              <h2 className="text-heading-4 font-normal">TeraCode.ai</h2>
              <div>
                <p className="text-secondary/80 dark:text-accent/80">
                  ...
                  digital world, threatening the livelihoods and originality of countless creators. TeraCode.ai stands
                ...
                <p className="text-secondary/80 dark:text-accent/80">
                  Instead of taking from artists, TeraCode.ai empowers them. The platform allows creators to train AI
                ...
                <p className="text-secondary/80 dark:text-accent/80">
                  With TeraCode.ai, illustrators can streamline their workflow from sketching and ideation to final
                ...
                <p className="text-secondary/80 dark:text-accent/80">
                  Built on transparency, ownership, and respect for creativity, TeraCode.ai represents the future of
                ...
                <p className="text-secondary/80 dark:text-accent/80">
                  ...
                  integrity, TeraCode.ai helps you turn your art into a sustainable, AI-powered creative ecosystem where

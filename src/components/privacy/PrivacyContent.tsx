...
const rightsSection: ListSection = {
  ...
  items: [
    ...
    {
      content:
        'If you wish to exercise these rights, please contact us at <a href="mailto:support@TeraCode.com" class="text-secondary dark:text-accent">support@TeraCode.com</a>',
    },
  ],
};
        ...
        <div className="privacy-policy space-y-[75px]">
          ...
          <div className="space-y-2">
            ...
            <RevealAnimation delay={0.2}>
              <p>
                <span className="text-secondary dark:text-accent">TeraCode</span> is a product operated by
                <span className="text-secondary dark:text-accent">TeraCode Technologies LLC</span>. We specialize in
          ...
          <RevealAnimation delay={0.3}>
            <div className="space-y-2">
              ...
              <p>
                ...
                <Link href="https://TeraCode.com" className="text-secondary dark:text-accent">
                  https://TeraCode.com
                </Link>
                (the &quot;Site&quot;).
              </p>

...
const policySections: PolicySection[] = [
  {
    ...
    content:
      'At TeraCode, we are committed to providing you with the best possible service and experience. However, if for any reason our platform does not meet your expectations, we offer a simple and hassle-free refund policy.',
  },
  {
    title: '14-Day money-back guarantee',
    content:
      'We are confident that you will love using TeraCode. Still, if you are not fully satisfied, we offer a full refund within 14 days of your original purchase — no questions asked.',
  },
];
...
const nonRefundableSituations: ListSection = {
  ...
  description:
    'TeraCode reserves the right to suspend or terminate any user account without prior notice for reasons including but not limited to',
  items: [
...
const additionalSections: PolicySection[] = [
  ...
  },
  {
    ...
    content:
      'If you choose to request a refund, we would be grateful if you could let us know why. Your feedback helps us improve TeraCode for future users!',
  },
];

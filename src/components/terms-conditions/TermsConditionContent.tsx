        ...
        <RevealAnimation delay={0.3}>
          <div className="space-y-3">
            ...
            <div className="space-y-7">
              <p>
                This site, TeraCode.com (hereafter referred to as TeraCode, site, or website) is owned and operated by
                TeraCode Technologies LLC (hereafter referred to as TeraCode, we, or company).
              </p>
              <p>
                Please carefully read, review, and understand our Terms and Conditions before using any services or
                products from TeraCode.com. Your access to and use of this website and its products indicate that you
        ...
        <article className="terms-conditions-body">
          <RevealAnimation delay={0.4}>
            <div className="space-y-6">
              ...
              <p>
                Under no circumstances shall TeraCode be liable for any direct, indirect, incidental, special, or
                consequential damages, including but not limited to loss of data, profits, or business interruption,
                arising out of the use, or inability to use, the materials on this site, even if TeraCode or an
          ...
          <RevealAnimation delay={0.5}>
            <div className="space-y-6">
              <h3>2. License</h3>
              <p>
                TeraCode services, platforms, and tools are provided under a commercial license agreement. Each
              ...
              <p>
                ...
                redistribute, or offer TeraCode products or services, modified or unmodified, without our written
                consent.
              </p>
            </div>
          </RevealAnimation>
          <RevealAnimation delay={0.6}>
            <div className="space-y-6">
              ...
              <p>
                All TeraCode products, solutions, and materials remain the intellectual property of TeraCode
              ...
              <p>
                ...
                implied. TeraCode is not liable for any losses or damages resulting from the use or inability to use its
                products.
              </p>
              <p>
          ...
          <RevealAnimation delay={0.3}>
            <div className="space-y-6">
              ...
              <p>
                We believe you&apos;ll love TeraCode! Still, if you&apos;re not satisfied, we offer a 14-day
          ...
          <RevealAnimation delay={0.5}>
            <div className="space-y-6">
              <h3>5. Warranty</h3>
              <p>
                TeraCode services are provided without any warranty, either expressed or implied. We do not guarantee
          ...
          <RevealAnimation delay={0.6}>
            <div className="space-y-6">
              ...
              <p>
                TeraCode reserves the right to suspend or terminate any user account without prior notice for reasons
                including but not limited to
              </p>
              <ul>
                <li>Abusive, defamatory, or malicious behavior towards TeraCode staff or customers</li>
          ...
          <RevealAnimation delay={0.3}>
            <div className="space-y-6">
              ...
              <p>
                We value your privacy. TeraCode does not sell, rent, or share your personal information with third
              ...
              <p>
                By using TeraCode services, you consent to the collection and use of your data by our Privacy Policy.
              </p>
            </div>
          </RevealAnimation>
          <RevealAnimation delay={0.4}>

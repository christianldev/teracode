...
const GdprContent = () => {
  ...
  const dataPurposes: ListItem[] = [
    { id: 'account-management', text: 'To create and manage your TeraCode account' },
  ...
  const dataManagementItems: ListItem[] = [
    ...
    {
      id: 'data-deletion',
      text: 'To request a complete data deletion or data export, simply send an email to: support@TeraCode.com',
    },
  ];
        ...
        <div className="space-y-[70px]">
          ...
          <RevealAnimation delay={0.3}>
            <div className="space-y-3">
              <h2>TeraCode and the general data protection regulation (GDPR)</h2>
              <p>
                ...
                <br />
                <br />
                This page explains how TeraCode implements GDPR principles and ensures that your data is handled
          ...
          <RevealAnimation delay={0.4}>
            <div className="space-y-6">
              <div className="space-y-3">
                ...
                <p>
                  At TeraCode, we are fully committed to respecting your privacy. This page provides a clear overview
                  of:
                </p>
              </div>
          ...
          <RevealAnimation delay={0.5}>
            <div className="space-y-3">
              ...
              <p>
                ...
                TeraCode) must be transparent about what data they collect, how they use it, and how they share it — and
                ...
                residents, including TeraCode.
              </p>
            </div>
          </RevealAnimation>
          {/* How TeraCode Implements GDPR */}
          <RevealAnimation delay={0.3}>
            <div className="space-y-3">
              <h3 className="text-heading-4">How TeraCode Implements GDPR</h3>
              <p>
                TeraCode has always prioritized user data privacy, even before GDPR came into effect. Our core practices
                    ...
                    <span className="text-tagline-1 text-secondary/60 dark:text-accent/60">
                      {item.id === 'data-deletion' ? (
                        <>
                          ...
                          <span className="text-secondary dark:text-accent">support@TeraCode.com</span>
                        </>
                      ) : (
                        item.text
                      )}

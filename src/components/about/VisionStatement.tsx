      ...
      <div className="main-container space-y-14 md:space-y-[70px]">
        <div className="mx-auto max-w-[780px] space-y-3 text-center">
          ...
          <RevealAnimation delay={0.3}>
            <h2>TeraCode is defining the future landscape of business.</h2>
          </RevealAnimation>
          <RevealAnimation delay={0.4}>
            <p>
              In a rapidly evolving digital world, TeraCode stands at the forefront of innovation, transforming how

...
const faqData: FAQData[] = [
  {
    id: '1',
    question: 'What is the TeraCode Affiliate Program?',
    answer:
      'It is a revenue-sharing program where you promote TeraCode to your audience and earn a commission for every new paying customer you refer. You receive a unique tracking link, marketing assets, and a dedicated dashboard to monitor clicks, conversions, and payouts in real time.',
  },
  {
    id: '2',
    ...
    <section className="py-14 md:py-20 lg:py-28">
      <div className="main-container">
        <RevealAnimation delay={0.1}>
          <h2 className="text-center">FAQ for TeraCode affiliates program</h2>
        </RevealAnimation>

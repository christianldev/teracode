      ...
      <div className="main-container mb-[70px]">
        <RevealAnimation delay={0.1}>
          <div className="space-y-3 text-center">
            <h2>Welcome to the TeraCode documentation</h2>
            <p>Find everything you need to set up, customize, and master your TeraCode platform.</p>
          </div>
        </RevealAnimation>
      </div>
          ...
          <RevealAnimation delay={0.7}>
            <div className="space-y-6">
              <div className="space-y-2">
                ...
                <p>Tailor TeraCode to fit your business needs.</p>
              </div>
              <ul className="text-tagline-1 text-secondary/60 dark:text-accent/60 list-inside space-y-3 font-normal">
                <li>
                  <Link

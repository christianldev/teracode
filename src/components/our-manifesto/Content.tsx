        ...
        <div className="mx-auto max-w-[1100px] space-y-[42px]">
          <div className="space-y-2">
            ...
            <RevealAnimation delay={0.2}>
              <p className="w-full max-w-[590px]">
                We believe great products start with bold ideas and the courage to bring them to life. TeraCode exists
          ...
          <div className="space-y-2">
            ...
            <RevealAnimation delay={0.4}>
              <p className="w-full max-w-[750px]">
                ...
                TeraCode is designed to make your workflow smoother and your decisions clearer.
              </p>
            </RevealAnimation>
          </div>
          ...
          <RevealAnimation delay={0.9}>
            <div className="space-y-2">
              ...
              <p className="w-full max-w-[590px]">
                We design for what’s next. As technology evolves, TeraCode evolves too ensuring you always stay ahead,
                never behind.
              </p>
            </div>
          </RevealAnimation>
